...
(function() {
	...
	if (debug) {
		...
		function insertMessage (html) {
			const partyTabI = Array.from(document.querySelectorAll(`.Chat_tabsComponentContainer__3ZoKe .MuiButtonBase-root`)).findIndex((el) => el.textContent.includes("队伍"));
	...
	*/
	...
	function isPartySelected () {
		...
		return selectedTabEl && tabsEl && selectedTabEl.textContent.includes("队伍") && !tabsEl.classList.contains("TabsComponent_hidden__255ag");
	}
