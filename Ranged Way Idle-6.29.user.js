...
(function () {
    ...
    const globalVariables = {
        scriptVersion: GM_info?.script?.version || "6.29",
        ...
        gameInfoClass() {
            function initCharacterData() {
                function ws(obj) {
                    ...
                    globalVariables.gameStateNode = (e => e?.[Reflect.ownKeys(e).find(k => k.startsWith('__reactFiber$'))]?.return?.stateNode)(document.querySelector('[class^="GamePage"]'));
                }
